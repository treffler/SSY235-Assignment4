...
int main( int argc, char** argv )
{
    ...
    ros::init(argc, argv,
              "turtle_visualization",ros::init_options::AnonymousName);
...
////#>>>>TODO:INSTANTIATE THE TURTLE CLASS WITH THE VARIABLE my_turtle;
    ...
    turtle3D = turtleSpace::TurtleClass::createMarkerMesh("turtle", 12345,
   ...
   ros::Subscriber sub=n.subscribe("turtle_control",100,
                                   &turtleSpace::TurtleClass::CALLBACK_FUNCTION_FOR_TOPIC/*//#>>>>TODO: DEFINE THE CALLBACK FUNCTION FROM THE METHOD OF THE CLASS*/,
                                   &OBJECT/*//#>>>>TODO: DEFINE THE INSTANCE OF THE CLASS*/);
    ...
    while(ros::ok())
    {
        ...
        br.sendTransform(tf::StampedTransform(XXXXXXXXXXXXXXXXXXXXXXXX));

        ////#>>>>TODO:PUBLISH THE TURTLE MARKER
        turtle_marker_pub.publish(XXXXXXXXX/*//#>>>>TODO:USE THE MSG WITH TYPE MARKER*/)
