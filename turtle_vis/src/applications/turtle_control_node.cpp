...
int main( int argc, char** argv )
{
  ...
  ros::Publisher desired_pose_pub=
      n.advertise<DESIRED_POSE_TOPIC_TYPE/*#>>>>TODO: DEFINE THE MSG TYPE*/>("turtle_control",100);
  ...
  //LOAD p_ain FROM THE ROS PARAMETER SERVER
  if (ros::param::has(/*/#>>>>TODO: DEFINE PARAMETER*/))
  {
    ros::param::get(/*/#>>>>TODO: DEFINE PARAMETER, SAME AS LINE 88*/,p);
    ROS_INFO_STREAM("p gain= "<<p);
  }
  else
  {
    ROS_ERROR_STREAM("param: control_gain/p_ain, doesn't exist" );
    return 1;
  }
  ...
  turtle_vis::XXXX desired_pose_msg; //#>>>>TODO:DEFINE THE MSG TYPE
